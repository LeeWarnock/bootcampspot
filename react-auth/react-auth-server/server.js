...
//We will change this to query a database
const authCheck = jwt({
  secret: new Buffer('L6Skl-NecXAmcX3tPj7UIXgLyOsEuDVzH9H4HPV-ExqhNrYARCHqJG3wkqo_Ti47', 'base64'),
  audience: 'tIzXo5cwrgVER823cSlyfFKHAUSV1S8s'
});
